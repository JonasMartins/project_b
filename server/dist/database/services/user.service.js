...
let UserService = class UserService {
    constructor() {
        ...
        this.getOne = (id) => __awaiter(this, void 0, void 0, function* () {
            const user = yield user_entity_1.User.findOne({ where: { id } });
            if (!user) {
        ...
        this.create = (options) => __awaiter(this, void 0, void 0, function* () {
            return yield user_entity_1.User.create(options).save();
        });
        this.update = (id, options) => __awaiter(this, void 0, void 0, function* () {
            const user = yield user_entity_1.User.findOne({ where: { id } });
            if (!user) {
