...
export type GeneralCountType = {
  __typename?: 'GeneralCountType';
  count: Scalars['Float'];
  errors?: Maybe<Array<ErrorFieldHandler>>;
};
...
export type Query = {
  ...
  getCountUnsawUserNotifications: GeneralCountType;
...
export type QueryGetCountUnsawUserNotificationsArgs = {
  userId: Scalars['String'];
};
...
export type AddSeenNotificationMutation = { __typename?: 'Mutation', addSeenNotification: { __typename?: 'GeneralResponse', done?: boolean | null | undefined, errors?: Array<{ __typename?: 'ErrorFieldHandler', message: string }> | null | undefined } };
...
export type CreateNotificationMutationVariables = Exact<{
  creatorId: Scalars['String'];
  description: Scalars['String'];
  usersRelatedIds: Array<Scalars['String']> | Scalars['String'];
}>;


export type CreateNotificationMutation = { __typename?: 'Mutation', createNotification: { __typename?: 'NotificationRespose', errors?: Array<{ __typename?: 'ErrorFieldHandler', message: string }> | null | undefined, notification?: { __typename?: 'Notification', id: string } | null | undefined } };
...
export type GetCountUnsawUserNotificationsQueryVariables = Exact<{
  userId: Scalars['String'];
}>;


export type GetCountUnsawUserNotificationsQuery = { __typename?: 'Query', getCountUnsawUserNotifications: { __typename?: 'GeneralCountType', count: number, errors?: Array<{ __typename?: 'ErrorFieldHandler', message: string }> | null | undefined } };
...
export type GetPostsQuery = { __typename?: 'Query', getPosts: { __typename?: 'PostsResponse', errors?: Array<{ __typename?: 'ErrorFieldHandler', message: string, method: string, field: string }> | null | undefined, posts?: Array<{ __typename?: 'Post', id: string, body: string, files?: Array<string> | null | undefined, createdAt: any, creator: { __typename?: 'User', id: string, name: string, picture?: string | null | undefined }, emotions?: Array<{ __typename?: 'Emotion', id: string, type: EmotionType, creator: { __typename?: 'User', id: string, name: string } }> | null | undefined, comments?: Array<{ __typename?: 'Comment', id: string, body: string, order: number, createdAt: any, author: { __typename?: 'User', id: string, name: string, picture?: string | null | undefined }, replies: Array<{ __typename?: 'Comment', id: string, body: string, createdAt: any, order: number, author: { __typename?: 'User', id: string, name: string, picture?: string | null | undefined } }> }> | null | undefined }> | null | undefined } };
...
export type GetUserByIdQuery = { __typename?: 'Query', getUserById: { __typename?: 'UserResponse', errors?: Array<{ __typename?: 'ErrorFieldHandler', message: string, field: string, method: string }> | null | undefined, user?: { __typename?: 'User', id: string, name: string, email: string, picture?: string | null | undefined, connections?: Array<{ __typename?: 'User', id: string, name: string, picture?: string | null | undefined }> | null | undefined, posts?: Array<{ __typename?: 'Post', id: string, body: string, files?: Array<string> | null | undefined, createdAt: any, creator: { __typename?: 'User', id: string, name: string, picture?: string | null | undefined }, emotions?: Array<{ __typename?: 'Emotion', id: string, type: EmotionType, creator: { __typename?: 'User', id: string, name: string } }> | null | undefined, comments?: Array<{ __typename?: 'Comment', id: string, body: string, createdAt: any, order: number, author: { __typename?: 'User', id: string, name: string, picture?: string | null | undefined }, replies: Array<{ __typename?: 'Comment', id: string, body: string, order: number, createdAt: any, author: { __typename?: 'User', id: string, name: string, picture?: string | null | undefined } }> }> | null | undefined }> | null | undefined } | null | undefined } };
...
export type GetUserNotificationsQuery = { __typename?: 'Query', getUserNotifications: { __typename?: 'UserResponse', errors?: Array<{ __typename?: 'ErrorFieldHandler', message: string }> | null | undefined, user?: { __typename?: 'User', id: string, relatedNotifications?: Array<{ __typename?: 'Notification', id: string, description: string, createdAt: any, userSeen: Array<string>, creator: { __typename?: 'User', id: string, name: string, picture?: string | null | undefined } }> | null | undefined } | null | undefined } };
...
export const AddSeenNotificationDocument = gql`
  ...
  addSeenNotification(userId: $userId, notificationId: $notificationId) {
    ...
    `;
export type AddSeenNotificationMutationFn = Apollo.MutationFunction<AddSeenNotificationMutation, AddSeenNotificationMutationVariables>;
 ...
 * });
 */
export function useAddSeenNotificationMutation(baseOptions?: Apollo.MutationHookOptions<AddSeenNotificationMutation, AddSeenNotificationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddSeenNotificationMutation, AddSeenNotificationMutationVariables>(AddSeenNotificationDocument, options);
      }
export type AddSeenNotificationMutationHookResult = ReturnType<typeof useAddSeenNotificationMutation>;
export type AddSeenNotificationMutationResult = Apollo.MutationResult<AddSeenNotificationMutation>;
export type AddSeenNotificationMutationOptions = Apollo.BaseMutationOptions<AddSeenNotificationMutation, AddSeenNotificationMutationVariables>;
...
export const CreateNotificationDocument = gql`
    mutation CreateNotification($creatorId: String!, $description: String!, $usersRelatedIds: [String!]!) {
  createNotification(
    creatorId: $creatorId
 ...
 *      usersRelatedIds: // value for 'usersRelatedIds'
 *   },
 * });
 */
...
export const GetCountUnsawUserNotificationsDocument = gql`
    query GetCountUnsawUserNotifications($userId: String!) {
  getCountUnsawUserNotifications(userId: $userId) {
    errors {
      message
    }
    count
...
/**
 * __useGetCountUnsawUserNotificationsQuery__
 *
 * To run a query within a React component, call `useGetCountUnsawUserNotificationsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetCountUnsawUserNotificationsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetCountUnsawUserNotificationsQuery({
 *   variables: {
 *      userId: // value for 'userId'
 *   },
 * });
 */
export function useGetCountUnsawUserNotificationsQuery(baseOptions: Apollo.QueryHookOptions<GetCountUnsawUserNotificationsQuery, GetCountUnsawUserNotificationsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCountUnsawUserNotificationsQuery, GetCountUnsawUserNotificationsQueryVariables>(GetCountUnsawUserNotificationsDocument, options);
      }
export function useGetCountUnsawUserNotificationsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCountUnsawUserNotificationsQuery, GetCountUnsawUserNotificationsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetCountUnsawUserNotificationsQuery, GetCountUnsawUserNotificationsQueryVariables>(GetCountUnsawUserNotificationsDocument, options);
        }
export type GetCountUnsawUserNotificationsQueryHookResult = ReturnType<typeof useGetCountUnsawUserNotificationsQuery>;
export type GetCountUnsawUserNotificationsLazyQueryHookResult = ReturnType<typeof useGetCountUnsawUserNotificationsLazyQuery>;
export type GetCountUnsawUserNotificationsQueryResult = Apollo.QueryResult<GetCountUnsawUserNotificationsQuery, GetCountUnsawUserNotificationsQueryVariables>;
